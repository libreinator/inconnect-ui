...
const Uploader = () => {
  ...
  return (
    <div className="hero">
      ...
      <p className="convert-paragraph">
        Convert speech to sign language easily
      </p>
          ...
          {audioSrc ? (
            <>
              <div className="container-1">
                ...
                <button onClick={(e) => handleCancel(e)} className="btn">
                  Cancel
                </button>
              </div>
      ...
      <button onClick={handleProceed} className="btn-2">
        Convert
      </button>
    </div>
  );
